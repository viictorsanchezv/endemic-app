          ...
          <div class="card-body">
            <form action="{{ route('diseases.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group mt-3">
                    <label>Fecha:</label>
                    <input type="text" name="date" class="form-control mt-3" required>
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="cases" class="form-control mt-3" required>
                ...
                <div class="form-group mt-3">
                    ...
                    <input name="description" class="form-control mt-3" required>
